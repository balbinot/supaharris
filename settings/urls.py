...
router.register(
    r"catalogue/astro_object_classifcation",
    catalogue_api.AstroObjectClassificationViewSet,
)
...
router.register(
    r"catalogue/observation_table",
    catalogue_api.ObservationTableViewset,
    basename="observation_table",
)
